...
public class SphereGenerator : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            noiseToVerts = Random.Range(-0.5f, 0.5f);
            vertices[i].x = originalVertices[i].x + noiseToVerts;
            vertices[i].y = originalVertices[i].y + noiseToVerts;
            vertices[i].z = originalVertices[i].z + noiseToVerts;
